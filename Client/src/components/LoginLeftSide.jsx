const LoginLeftSide = () => {
  return (
    <div className="hidden md:flex w-1/2 bg-indigo-950 relative overflow-hidden border-r border-slate-200">
      ...
      <div className="relative z-10 flex flex-col justify-center items-start px-12 lg:p-20 w-full h-full">
        ...
        <p className="text-slate-400 text-lg max-w-md leading-relaxed">
          Streamline your workflow operation, track attendance, manage payrolls,
          and empower your team security.
        </p>
      </div>
    </div>
  );
